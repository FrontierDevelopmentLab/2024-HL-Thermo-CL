...
input_dir='../data/omniweb_data_raw'
files=os.listdir(input_dir)
files=[os.path.join(input_dir,f) for f in files if f.endswith('.txt') and f.startswith('data_')]

output_dir='../data/omniweb_data'
...
for file_path in tqdm(files):
    ...
    data_omni_magnetic_field.to_csv(os.path.join(output_dir,f'magnetic_field_omni_{file_date}.csv'),index=False)
    data_omni_solar_wind_velocity.to_csv(os.path.join(output_dir,f'solar_wind_velocity_omni_{file_date}.csv'),index=False)
    data_omni_indices.to_csv(os.path.join(output_dir,f'indices_omni_{file_date}.csv'),index=False)
    print('done')